...
//        assertNotEquals(cuenta2, cuenta);
    ...
    class CuentaOperacionesTest{
        ...
        void testTransferirDineroCuentas() {
            ...
            banco.tranferencia(cuenta2, cuenta1, new BigDecimal(500));
    ...
    void testDineroInsuficienteExceptionCuenta() {
        Exception exception = assertThrows(DineroInsificienteException.class, () -> {
    ...
    void testRelacionBancoCuentas() {
        ...
        assertAll(() -> assertEquals("1000.8989", cuenta2.getSaldo().toPlainString(),
                ...
                () -> assertEquals(2, banco.getListaCuenta().size(), () -> "el banco no tienes las cuentas esperadas"),
                () -> assertEquals("Banco del Estado", cuenta1.getBanco().getName()),
                () -> assertEquals("Andres", banco.getListaCuenta().stream()
                        .filter(c -> c.getName().equals("Andres"))
                        .findFirst()
                        .get().getName()),
                () -> assertTrue(banco.getListaCuenta().stream()
                        .anyMatch(c -> c.getName().equals("Jhon Doe"))));
    }
    ...
    class PruebasParametrizadasTest{
        ...
        void testDebitoCuentaCsvSource2(String saldo, String monto, String esperado, String actual) {
            ...
            cuenta.debit(new BigDecimal(monto));
            cuenta.setName(actual);

            assertNotNull(cuenta.getSaldo());
            assertNotNull(cuenta.getName());
            assertEquals(esperado, actual);
            assertTrue(cuenta.getSaldo().compareTo(BigDecimal.ZERO) > 0);
        }
